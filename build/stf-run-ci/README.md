...
| `sto_dir`                                                            | <directory_path>                                            | `{{ playbook_dir }}/..`                               |
 The location of the service-telemetry-operator directory (needed to set the other repo paths)                                             |
| `sgo_dir`                                                            | <directory_path>                                            | `{{ sto_dir }}/build/working/smart-gateway-operator`
 The directory to clone smart-gateway-operator into (when clone_repos == true) or the location of the the repo (when clone_repos == false) |
