...
| `__service_telemetry_events_endpoint_cert_duration`    | [ParseDuration](https://golang.org/pkg/time/#ParseDuration) | 2160h              | Lifetime of the ElasticSearch endpoint certificate (minimum duration is 1h)                                         |
| `__service_telemetry_events_ca_cert_duration`          | [ParseDuration](https://golang.org/pkg/time/#ParseDuration) | 70080h             | Lifetime of the ElasticSearch CA certificate (minimum duration is 1h)                                               |
...
| `__service_telemetry_transports_endpoint_cert_duration`| [ParseDuration](https://golang.org/pkg/time/#ParseDuration) | 2160h              | Lifetime of the QDR endpoint certificate (minimum duration is 1h)                                                   |
| `__service_telemetry_transports_ca_cert_duration`      | [ParseDuration](https://golang.org/pkg/time/#ParseDuration) | 70080h             | Lifetime of the QDR CA certificate (minimum duration is 1h)                                                         |
