...
| `__service_telemetry_observability_strategy`                         | <observability_strategy>                                    | `use_redhat`                                          | Which observability strategy to use for deployment. Default is 'use_hybrid'. Also supported are 'use_hybrid', 'use_community', and 'none' |
