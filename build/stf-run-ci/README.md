...
| `__service_telemetry_observability_strategy`           | <observability_strategy> | `use_redhat`                                       | Which observability strategy to use for deployment. Default deployment is 'use_redhat'. Also supported are 'use_community', 'use_hybrid', and 'none' |
