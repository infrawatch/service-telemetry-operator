...
| `__deploy_from_index_enabled`                                        | {true,false}                                                | false                                                                         | Whether to deploy STF 
| `__disconnected_deploy`                                              | {true,false}                                                | false                                                                         | Whether to deploy on a disconected cluster                                                                                                                                                                                    |
from locally built bundles and index image.                                                                                                                                                       |
