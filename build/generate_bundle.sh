...
generate_bundle() {
    ...
    REPLACE_REGEX="s#<<CREATED_DATE>>#${CREATED_DATE}#g;s#<<OPERATOR_IMAGE_PULLSPEC>>#${OPERATOR_IMAGE_PULLSPEC}#g;s#<<RELATED_IMAGE_PROMETHEUS_WEBHOOK_SNMP_PULLSPEC>>#${RELATED_IMAGE_PROMETHEUS_WEBHOOK_SNMP_PULLSPEC}#g;s#<<RELATED_IMAGE_OAUTH_PROXY_PULLSPEC>>#${RELATED_IMAGE_OAUTH_PROXY_PULLSPEC}#g;s#<<RELATED_IMAGE_PROMETHEUS_PULLSPEC>>#${RELATED_IMAGE_PROMETHEUS_PULLSPEC}#g;s#<<RELATED_IMAGE_ALERTMANAGER_PULLSPEC>>#${RELATED_IMAGE_ALERTMANAGER_PULLSPEC}#g;s#<<RELATED_IMAGE_GRAFANA_PULLSPEC>>#${RELATED_IMAGE_GRAFANA_PULLSPEC}#g;s#<<OPERATOR_BUNDLE_VERSION>>#${OPERATOR_BUNDLE_VERSION}#g;s#1.99.0#${OPERATOR_BUNDLE_VERSION}#g;s#<<OPERATOR_DOCUMENTATION_URL>>#${OPERATOR_DOCUMENTATION_URL}#g"
