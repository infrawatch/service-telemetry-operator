...
buildah tag sto:latest ${REGISTRY}/service-telemetry/service-telemetry-operator:latest
...
buildah tag sgo:latest ${REGISTRY}/service-telemetry/smart-gateway-operator:latest
...
buildah tag sg:latest ${REGISTRY}/service-telemetry/smart-gateway:latest
buildah push --tls-verify=false ${REGISTRY}/service-telemetry/smart-gateway:latest
